...
global.dfail = (type, m, conn, usedPrefix) => {
    const mensajes = {
        rowner: '╮──────────────╭\n│ *الامر ده مخصص لمطوري يعبد 😒.*🕴️\n╯──────────────╰',
owner: '╮──────────────╭\n│ *لا ينفذ هاذا الامر الا من مطوري ققط يا عبد.*🥃\n╯──────────────╰',
mods: '╮──────────────╭\n│ *فقط من يحمل ثقة العائلة، يمكنه استخدام هذا.*🔱\n╯──────────────╰',
premium: '╮──────────────╭\n│ *مش اي حد ياعاق ياخد الميزه دي 🍬*💎\n╯──────────────╰',
group: '╮──────────────╭\n│ *نفِّذ هذا الأمر داخل الجروب، وليس هنا.*🕶️\n╯──────────────╰',
private: '╮──────────────╭\n│ *تحدث إليّ على انفراد... هنا ليس المكان.*📩\n╯──────────────╰',
admin: '╮──────────────╭\n│ *فقط المسؤولون يملكون صلاحية كهذه.*🎩\n╯──────────────╰',
botAdmin: '╮──────────────╭\n│ *يغبي هات اشراف الاول 👻.*⚖️\n╯──────────────╰',
unreg: '╮──────────────╭\n│ *لا أحد يُخاطب العرّاب دون تقديم نفسه.*📜\n│ مثال: .تسجيل غيتو.22\n╯──────────────╰',
restrict: '╮──────────────╭\n│ *هذا الأمر تم تعليقه... لأسباب لا تخصك.*🕯️\n╯──────────────╰'
    }
